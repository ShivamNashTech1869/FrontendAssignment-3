...
public class SearchStepDefinition {
    ...
    public void iShouldSeeTheBuyNowButton() {
    ...
    public void i_should_check_if_customer_rating_for_the_product_is_over_four() {
    ...
    public void print_all_the_offers_available_on_the_description_page_for_the_product() {
